...
> To also collect logs from **Komodo DinD**, uncomment the volume and Alloy config blocks marked with "Komodo" in `crisler-lgtm-stack/docker-compose.yml` and `crisler-lgtm-stack/config.alloy`.
